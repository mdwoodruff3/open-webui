...
usage() {
    ...
    echo "  $0 --enable-gpu[count=1] --enable-api[port=12345] --webui[port=4000]"
    echo "  $0 --enable-gpu[count=1] --enable-api[port=12345] --webui[port=4000] --data[folder=./ollama-data]"
    echo "  $0 --enable-gpu[count=1] --enable-api[port=12345] --webui[port=4000] --data[folder=./ollama-data] --build"
    echo ""
